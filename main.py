            ...
            item(
                ...
                menu(
                    ...
                    item(
                        "10 minutes",
                        self.wallpaper_manager.select_interval,
                        checked=lambda item: self.wallpaper_manager.timeout == 60 * 10,
                    ),
                    item(
                        "30 minutes",
                        self.wallpaper_manager.select_interval,
                        checked=lambda item: self.wallpaper_manager.timeout == 60 * 30,
                    ),
                    item(
                        "1 hour",
                        self.wallpaper_manager.select_interval,
                        checked=lambda item: self.wallpaper_manager.timeout == 60 * 60,
                    ),
                    item(
                        "6 hours",
                        self.wallpaper_manager.select_interval,
